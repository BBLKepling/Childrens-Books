    ...
    public class JobDriver_BedTimeStory : JobDriver
    {
        ...
        protected Toil ReadToil()
        {
            ...
            toil.tickAction = delegate
            {
                ...
                if (isLearningDesire && Child.needs.learning.CurLevel < 1) Child.needs.learning.Learn(1.2E-05f * LearningUtility.LearningRateFactor(Child));
            ...
            toil.AddFinishAction(delegate
            {
                ...
                TaleRecorder.RecordTale(ChildrensBookDefOf.BBLK_BedTimeStory_Tale, pawn, Child, Book);
            });
            return toil;
        }
